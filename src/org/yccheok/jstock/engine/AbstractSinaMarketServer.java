 ...
 * @author yccheok
 */
public abstract class AbstractSinaMarketServer implements MarketServer {
    ...
    public java.util.List<Market> getMarkets(java.util.List<Index> indices) {
        ...
        System.out.println("AbstractSinaMarketServer::getMarkets()");
        StockServer stockServer = AbstractSinaMarketServer.this.getStockServer();
    ...
    private static final Log log = LogFactory.getLog(AbstractSinaMarketServer.class);
}
