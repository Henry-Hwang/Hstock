 ...
 * @author yccheok
 */
public abstract class AbstractSinaStockHistoryServer implements StockHistoryServer {        
    ...
    public AbstractSinaStockHistoryServer(Code code) throws StockHistoryNotFoundException
    {
        this(code, DEFAULT_HISTORY_DURATION);
    }

    public AbstractSinaStockHistoryServer(Code code, Duration duration) throws StockHistoryNotFoundException
    {
        System.out.println("AbstractSinaStockHistoryServer::AbstractSinaStockHistoryServer()");
    ...
    private static final Log log = LogFactory.getLog(AbstractSinaStockHistoryServer.class);
}
