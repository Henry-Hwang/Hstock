 ...
 * @author yccheok
 */
public class SinaDividendServer implements DividendServer {

    @Override
    public List<Dividend> getDividends(Code code, Duration duration) {
        System.out.println("SinaDividendServer::getDividends(Code, Duration)");
    ...
    private static final Log log = LogFactory.getLog(SinaDividendServer.class);
}
